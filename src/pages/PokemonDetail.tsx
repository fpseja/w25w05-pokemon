...
export default function PokemonDetail() {
    ...
    const { data: pokemon, isLoading } = useQuery({
        ...
        queryFn: async () => {
            ...
            const koreanName = species.names.find((n: NameEntry) => n.language.name === "ko")?.name
            const flavorText =
                species.flavor_text_entries.find((f: PokeFlavorText) => f.language.name === "ko")?.flavor_text ||
                "(설명이 없습니다.)"
            ...
            return {
                ...
                types: detail.types.map((t: PokeType) => t.type.name),
                height: detail.height,
                weight: detail.weight,
                stats: detail.stats.map((s: PokeStat) => ({
                    name: s.stat.name,
                    value: s.base_stat,
                })),
                flavorText,
    ...
    if (!pokemon) return <p className="text-center mt-10">포켓몬을 찾을 수 없습니다.</p>;
        ...
        <div className="p-6 flex flex-col items-center">
            ...
            >
                ...
                <div className="flex gap-2 mt-3">
                    {pokemon.types.map((t: keyof typeof typeColors) => (
                        <span
                            key={t}
            ...
            <div className="w-full max-w-2xl bg-white rounded-2xl shadow-md p-6 space-y-6">
                ...
                <section>
                    ...
                    <div className="space-y-2">
                        {pokemon.stats.map((s: PokeStat["stat"]) => (
                            <div key={s.name}>
